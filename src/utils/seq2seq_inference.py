...
from src.models.Decoder import Decoder, OneStepDecoder, DecoderWithAttention, OneStepDecoderWithAttention
...
def seq2seq_inference_with_attention(checkpoint_filename):
    """
