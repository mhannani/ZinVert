...
class ZinVertHandlerWithAtt(BaseHandler):
    """
    ...
    def inference(self, data):
        ...
        encoder_outputs, hidden = self.model.encoder(data)
        ...
        with torch.no_grad():
            for _ in range(30):
                print('sos_or_next_token_tensor, hidden, encoder_outputs', sos_or_next_token_tensor.shape, hidden.shape, encoder_outputs.shape)
                output, hidden, cell = self.model.decoder.one_step_decoder(sos_or_next_token_tensor, hidden, encoder_outputs)
